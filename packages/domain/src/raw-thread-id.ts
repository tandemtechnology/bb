...
/** Alphabet used by persisted IDs generated by bb. */
export const GENERATED_ID_ALPHABET = "23456789abcdefghijkmnpqrstuvwxyz";

/** Suffix length used by persisted IDs generated by bb. */
export const GENERATED_ID_SUFFIX_LENGTH = 10;

export const THREAD_ID_PREFIX = "thr_";

/** Browser-safe regexp source for a complete currently generated thread ID. */
...
export type RawThreadId = z.infer<typeof rawThreadIdSchema>;
